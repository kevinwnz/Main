...
$.fn.calendar.defaults={Date:Date,width:180,height:180,fit:false,border:true,showWeek:false,firstDay:0,weeks:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],months:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
$(_708).addClass("spinner-f").textbox($.extend({},opts,{icons:_70a,doSize:true,onResize:function(_70c,_70d){
if(!opts.spinArrow){
var span=$(this).next();
